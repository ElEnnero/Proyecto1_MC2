...
#Label con las instrucciones
Label1=tk.Label(root,text="Ingrese el nodo a crear")
Label1.pack()
Label1.config(bg="white", font=("Helvetica",14))

#Creación del botón de agregar vértice y la entrada de la vertice
...
#Creación del label para conectar nodos
Label2=tk.Label(root, text="Ingrese los nodos a conectar")
Label2.pack()
Label2.config(bg="white", font=("Helvetica",14))

#frame para ordenar mejor lo botones
frame2=tk.Frame(root, background="white")
frame2.pack()

#Creación del botón de agragar arista y sus entradas de vértices
...
#creación de lienzo dobre el cual se dibujará el grafo
figure = Figure(figsize=(7, 4))
ax = figure.add_subplot(111)
canvas = FigureCanvasTkAgg(figure, root)
canvas.get_tk_widget().pack()

#Otro contenedor para los botones
frame=tk.Frame(root)
frame.pack()
frame.config(background="white")

#Creación del botón que realiza la búsqueda en anchura
...
#Creación del botón que realiza la búsqueda en profundidad
...
#Label que indica lo que se ejecutó
